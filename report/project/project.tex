...
In order to link the experimental setup with a real-world application, we will consider the following task. There are several patrol robots patrolling a grid, however a subset of these robots are attackers, which aim to prevent their victims discovering a part of the environment. To do this, they will attack all normal robots in the vicinity of the special zone. Normal robots will only communicate with others if they have sensed them, whilst attackers may seek to also communicate with robots that they have not sensed.
