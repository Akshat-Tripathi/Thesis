...
This section will introduce the reader to the core concepts used in the \textbf{Robot Web} and assemble them to provide the reader with an understanding of how the \textbf{Robot Web} functions and some of its limitations.
...
% Robot web uses factor graphs, and lie theory. Each robot has a couple of variables for its internal pose estimate connected by factors. When a robot senses another near it, it will create a factor between it and the latest pose variable of the other robot.
