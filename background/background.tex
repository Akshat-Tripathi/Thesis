...
This section will introduce the reader to the core concepts used in the \textbf{Robot Web} and assemble them to provide the reader with an understanding of how the Robot Web functions.
